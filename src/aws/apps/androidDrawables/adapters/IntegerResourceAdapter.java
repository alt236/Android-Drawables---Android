...
public class IntegerResourceAdapter extends AbstractResourceAdapter {
	private final List<ResourceInfo> items;
	private final Context context;

	public IntegerResourceAdapter(Context context, int textViewResourceId, List<ResourceInfo> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (o != null) {			
			...
			int value = context.getResources().getInteger(o.getId());
